...
The training and validation loss and accuracy scores are both separated by wide margins indicating the model is very over-fit. The training curves both follow an exponential pattern which indicates a good learning rate.
